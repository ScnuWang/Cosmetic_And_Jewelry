...
query_term = "&@QueryTerm=*&CategoryUUIDLevelX=fQcKaSUCzHcAAAEnktxToUKM&CategoryUUIDLevelX%2FfQcKaSUCzHcAAAEnktxToUKM=fk0KaVgfKRcAAAFjv9t6fYxb&CategoryUUIDLevelX%2FfQcKaSUCzHcAAAEnktxToUKM%2Ffk0KaVgfKRcAAAFjv9t6fYxb=mQUKaVgfEYoAAAFj0tt6fYxb&@Sort.FFSort=0&@Page="
...
while page_count <= total_count:
    ...
    fileName = str(1) + '_' + str(file_time) + '_' + str(2) + '_' + str(3) + '_' + str(page_count) + '.json'
