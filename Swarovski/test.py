...
def all(website_url,url,query_term,sales_location,category_id):
    ...
    while page_count <= total_count:
        ...
        fileName = str(1)+'_' + str(file_time)+'_' + str(1)+'_'+str(sales_location)+'_' + str(page_count) + '.json'
...
query_term = "&@QueryTerm=*&CategoryUUIDLevelX=B8kKaSUCmAEAAAEnLNBToUKM&CategoryUUIDLevelX%2FB8kKaSUCmAEAAAEnLNBToUKM=KdcKaVgfUt4AAAFjkPF6fYwv&CategoryUUIDLevelX%2FB8kKaSUCmAEAAAEnLNBToUKM%2FKdcKaVgfUt4AAAFjkPF6fYwv=jCQKaVgf.bQAAAFjwvF6fYwv&@Sort.FFSort=0&@Page="
